    ...
    return {
      select: (columns: string = '*') => {
        ...
        if (tableName === 'users') {
          ...
          rlsRule = "Anyone can read sponsored products";
          ...
          rlsRule = "Anyone can read favorites";
          queryData = (sandboxData as any).favorites || [];
        } else if (tableName === 'order_tracking') {
          rlsRule = "Anyone can read order_tracking";
          queryData = (sandboxData as any).order_tracking || [];
      ...
      update: (payload: any) => {
        ...
        const chain: any = {
          ...
          eq: (column: string, value: any) => {
            ...
            else if (tableName === 'products') targetCollection = (sandboxData as any).products || [];
